...
export const getUpdateRunnerProfileUrl = () => {
...
export const updateRunnerProfile = async (profileUpdateInput: ProfileUpdateInput, options?: Parameters<typeof customFetch>[1]): Promise<AccountStatus> => {
...
return customFetch<AccountStatus>(getUpdateRunnerProfileUrl(),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...getHeaders(options?.headers) },
...
export const getUpdateRunnerProfileMutationKey = () => ['updateRunnerProfile'] as const;

export const getUpdateRunnerProfileMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateRunnerProfile>>, TError,UpdateRunnerProfileMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateRunnerProfile>>, TError,UpdateRunnerProfileMutationVariables, TContext> => {

const mutationKey = getUpdateRunnerProfileMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateRunnerProfile>>, UpdateRunnerProfileMutationVariables> = (props) => {
          const {data} = props ?? {};

          return  updateRunnerProfile(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateRunnerProfileMutationResult = NonNullable<Awaited<ReturnType<typeof updateRunnerProfile>>>
    export type UpdateRunnerProfileMutationBody = BodyType<ProfileUpdateInput>
    export type UpdateRunnerProfileMutationError = ErrorType<void>
    export type UpdateRunnerProfileMutationVariables = {data: BodyType<ProfileUpdateInput>}

    export const useUpdateRunnerProfile = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateRunnerProfile>>, TError,UpdateRunnerProfileMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateRunnerProfile>>,
        TError,
        UpdateRunnerProfileMutationVariables,
        TContext
      > => {
      return useMutation(getUpdateRunnerProfileMutationOptions(options));
    }
