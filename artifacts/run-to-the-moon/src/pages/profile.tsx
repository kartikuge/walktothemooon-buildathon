  ...
  return (
    <div className="p-6 space-y-8 animate-in fade-in duration-500 mt-4 pb-28">
      ...
      <div className="flex flex-col gap-4">
        ...
        <Link href="/passport" className="flex items-center gap-4 p-5 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-all active:scale-[0.98]">
        ...
        <Link href="/activity" className="flex items-center gap-4 p-5 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-all active:scale-[0.98]">
        ...
        <Link href="/stats" className="flex items-center gap-4 p-5 bg-card rounded-3xl border border-border shadow-sm hover:shadow-md transition-all active:scale-[0.98]">
